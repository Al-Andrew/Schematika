...
///Bocks
#define BLOCK_LIMITS_RIGHT (WINDOW_WIDTH - SELECT_BLOCK_MENU_WIDTH - MENU_BORDER_WIDTH - DECIZIE_WIDTH/2 - NODE_RADIUS)
#define BLOCK_LIMITS_UP (WINDOW_HEIGHT - SELECT_MENU_HEIGHT - MENU_BORDER_WIDTH - DECIZIE_HEIGHT/2 - NODE_RADIUS)
#define BLOCK_LIMITS_DOWN (DECIZIE_HEIGHT/2 + NODE_RADIUS)
#define BLOCK_LIMITS_LEFT (DECIZIE_WIDTH/2 + NODE_RADIUS)
